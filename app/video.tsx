...
export default function VideoPage({ video }: { video: Video }) {
	...
	return (
		<section
			ref={sectionRef}
			className="h-screen w-screen bg-black flex items-center justify-center snap-start"
		>
			<div className="relative h-full w-full max-w-150 aspect-9/16">
				...
				<button
					onClick={toggleMute}
					className="absolute top-15 right-4 bg-black/50 p-2 rounded-full text-white md:top-3"
				>
				...
				<div className="absolute bottom-5 right-3 text-white z-10 space-y-5">
					<div className="relative bg-white/25 rounded-full p-1">
						...
						>
							<path
								d="M16.5361 25.1503L31.0642 2.84357e-06L39.6977 0L70.9999 54.2169L66.9364 61.255L19.5094 61.2547L27.1208 48.0713L52.2291 48.0723L35.3921 18.9072L31.7697 25.1503L16.5361 25.1503Z"
								fill="white"
							/>
							<path
								d="M12.258 32.5835L12.2614 32.5835L27.4929 32.5835L10.8776 61.3039L4.34502 61.3038L0 53.778L12.258 32.5835Z"
								fill="#53B5FF"
							/>
						</svg>

						<span className=" absolute -bottom-2 left-1/2 -translate-x-1/2 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-sm ">
							+
						</span>
					</div>
